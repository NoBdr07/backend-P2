...
public class SpringSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		RequestMatcher registerMatcher = new AntPathRequestMatcher("/api/auth/register");
		RequestMatcher docsMatcher = new AntPathRequestMatcher("/v3/api-docs/**");
		RequestMatcher swaggerMatcher = new AntPathRequestMatcher("/swagger-ui/**");
		RequestMatcher combinedMatcher = new OrRequestMatcher(registerMatcher, docsMatcher, swaggerMatcher);
